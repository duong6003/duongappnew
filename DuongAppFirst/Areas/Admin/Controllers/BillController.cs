...
using DuongAppFirst.Utillities.Helpers;
...
namespace DuongAppFirst.Areas.Admin.Controllers
{
    public class BillController : BaseController
    {
        ...
        public IActionResult ConfirmBill(int billId)
        {
            ...
            {
                _billService.UpdateStatus(billId, BillStatus.Completed);
                _billService.Save();
        ...
        public IActionResult ExportExcel(int billId)
        {
            ...
            using (FileStream templateDocumentStream = System.IO.File.OpenRead(templateDocument))
            {
                using (ExcelPackage package = new ExcelPackage(templateDocumentStream))
                {
                    ...
                    ExcelWorksheet worksheet = package.Workbook.Worksheets["DuongOrder"];
