        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function () {
                        duong.notify('Save user succesful', 'success');
                    ...
                    error: function () {
                        duong.notify('Has an error', 'error');
                        duong.stopLoading();
                    }
                });
            }
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            duong.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function () {
                        duong.notify('Delete successful', 'success');
                        duong.stopLoading();
                        loadData();
                    },
                    error: function () {
                ...
                if (response.RowCount > 0) {
                    $.each(response.Results, function (i, item) {
                        render += Mustache.render(template, {
                            ...
                            DateCreated: duong.dateTimeFormatJson(item.DateCreated),
