        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            duong.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        duong.notify('Deleted success', 'success');
                        duong.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        duong.notify('Has an error in deleting progress', 'error');
                        duong.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        duong.notify('Update success', 'success');
                    ...
                    error: function () {
                        duong.notify('Has an error in update progress', 'error');
                        duong.stopLoading();
                    }
                });
            }
