        ...
        public async Task Seed()
        {
            ...
            if (!_userManager.Users.Any())
            {
                await _userManager.CreateAsync(new AppUser()
                {
                    ...
                    Avatar = "/admin-side/images/admin.png",
                    Balance = 0,
            ...
            if (!_context.Contacts.Any())
            {
                _context.Contacts.Add(new Contact()
                {
                    ...
                    Address = "48A Bui Thi Xuan, Tan Binh District, Ho Chi Minh City",
                    Email = "duongvv10@gmail.com",
                    Name = "DuongShop",
                    Phone = "0912 324 543",
                    Status = Status.Active,
                    Website = "http://minhphongmacca.com",
                    Latitude = 10.79245601579889,
                    Longitude = 106.65574342154684
                });
            }
            ...
            if (_context.ProductCategories.Count() == 0)
            {
                List<ProductCategory> listProductCategory = new List<ProductCategory>()
                {
                    new ProductCategory() { Name="Men shirt",SeoAlias="men-shirt",ParentId = null,Status=Status.Active,SortOrder=1,
                        ...
                        {
                            new Product(){Name = "Product 1",DateCreated=DateTime.Now,Image="/client-side/images/products/product-1.jpg",SeoAlias = "san-pham-1",Price = 1000,Status = Status.Active,OriginalPrice = 1000,PrizeFlag=true},
